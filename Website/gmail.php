...
<section class="gmail-hero-master-nexus section-padding" id="gmailHeroMaster" style="background: #ffffff; position:relative; overflow-x: hidden; overflow-y: hidden;">
    ...
    <div style="position:absolute; top:-20%; right:-10%; width:500px; height:500px; background:radial-gradient(circle, rgba(66,133,244,0.04) 0%, transparent 70%); border-radius:50%; pointer-events:none;"></div>
    <div style="position:absolute; bottom:-20%; left:-10%; width:400px; height:400px; background:radial-gradient(circle, rgba(52,168,83,0.03) 0%, transparent 70%); border-radius:50%; pointer-events:none;"></div>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="800">
                <span class="gmail-hero-badge" style="display:inline-flex; align-items:center; gap:8px; background:#f1f3f4; color:#444; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid #e8eaed;">
                    <i class="fas fa-envelope me-2" style="color:#4285F4;"></i> Premium Gmail Solutions
                </span>
                <h1 class="gmail-hero-headline" style="font-size:clamp(2.8rem,7vw,4.8rem); font-weight:800; line-height:1.08; color:#111; margin-bottom:20px; font-family:'Playfair Display',serif;">
                    Premium <span style="position:relative; display:inline-block; color:#4285F4;">Gmail<span style="position:absolute; bottom:4px; left:0; width:100%; height:8px; background:rgba(66,133,244,0.12); border-radius:4px;"></span></span> Accounts
                </h1>
                <p class="gmail-hero-subtitle" style="font-size:1.1rem; color:rgba(0,0,0,0.6); max-width:520px; margin:0 0 28px 0; line-height:1.7;">
                    High-quality Gmail accounts for business, marketing, registration, verification, and digital growth.
                </p>
                <div class="gmail-hero-cta-group d-flex flex-wrap gap-3">
                    <a href="#gmailProducts" class="gmail-hero-btn-primary" style="background:#4285F4; color:#fff; border:none; padding:14px 36px; border-radius:60px; font-weight:700; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:10px; box-shadow:0 8px 24px rgba(66,133,244,0.25);">
    ...
    <div class="container">
        <div class="gmail-types-header text-center mb-5" data-aos="fade-up">
            ...
            <h2 class="gmail-types-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Choose Your <span style="position:relative; display:inline-block; color:#023b45;">Gmail<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Package
            </h2>
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">Select the perfect Gmail account type for your needs</p>
        </div>
        <div class="gmail-types-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="100">
                <div class="gmail-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    ...
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Fresh Gmail Accounts</h3>
                    ...
                    <!-- <a href="#gmailProducts" class="gmail-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;"></a> -->
                </div>
            </div>
            <!-- Type 2: PVA Gmail -->
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="150">
                <div class="gmail-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:2px solid #023b45; position:relative;">
                    ...
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">📞</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">PVA Gmail Accounts</h3>
                    ...
                    <!-- <a href="#gmailProducts" class="gmail-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;">Order Now →</a> -->
                </div>
            </div>
            <!-- Type 3: Aged Gmail -->
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="200">
                <div class="gmail-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">📜</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Aged Gmail Accounts</h3>
            ...
            <!-- Type 4: Business Gmail -->
            <!-- <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="250"> -->
                <!-- <div class="gmail-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">💼</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Business Gmail Accounts</h3>
            ...
            <!-- <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="300"> -->
                <!-- <div class="gmail-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">📦</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Bulk Gmail Packages</h3>
                    ...
                    <a href="#gmailProducts" class="gmail-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;">Inquire Now →</a>
                </div>
            </div>
        </div>
    </div> -->
   ...
   ========================================================= -->
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            .gmail-hero-master-nexus > div[style*="position:absolute"] {
...
<body>
        ...
        <div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4" id="productsGrid" data-aos="fade-up">
            ...
            <div class="col" data-product-id="gmail">
                <div class="attract-card">
                    <div class="badge-extra badge-best"><i class="fas fa-star"></i> -35%</div>
                    ...
                    <div class="card-content">
                        ...
                        <div class="btn-group-premium">
                            ...
                            <button class="btn-gradient-cart addCartBtn" data-name="Gmail Accounts"><i class="fas fa-shopping-cart"></i> <span class="cart-text">Add to Cart</span><span class="spinner"></span></button>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div class="col" data-product-id="gmail">
                <div class="attract-card">
                    <div class="badge-extra badge-best"><i class="fas fa-star"></i> -25%</div>
                    <div class="card-top-image">
                        <img src=" ../Image/gmail.jpg" alt="Gmail Accounts">
                    </div>
                    <div class="card-content">
                        <h3 class="card-title"><em>Gmail Accounts</em></h3>
                        <p class="short-desc"><em>Premium GSuite ready, aged profiles, instant access</em></p>
                        <h5><em>1 year Old</em></h5>
                        <div class="product-rating">
                            <div class="star-rating" data-product="gmail"></div>
                            <span class="rating-count" data-product="gmail">(128 reviews)</span>
                        </div>
                        <div class="price-modern">
                            <span class="current-price"><span class="price-unit">$</span>12</span>
  ...
  <div class="col" data-product-id="gmail">
                <div class="attract-card">
                    <div class="badge-extra badge-best"><i class="fas fa-star"></i> -40%</div>
                    <div class="card-top-image">
                        <img src=" ../Image/gmail.jpg" alt="Gmail Accounts">
                    </div>
                    <div class="card-content">
                        ...
                        <div class="price-modern">
                            <span class="current-price"><span class="price-unit">$</span>126</span>
  ...
  <div class="col" data-product-id="gmail">
                <div class="attract-card">
                    <div class="badge-extra badge-best"><i class="fas fa-star"></i> -50%</div>
                    <div class="card-top-image">
                        <img src=" ../Image/gmail.jpg" alt="Gmail Accounts">
                    </div>
                    <div class="card-content">
        ...
        (function() {
            ...
            const productData = {
                gmail: {
                    ...
                    reviews: [
                        { name: 'Alex J.', country: 'USA', text: 'Perfect Gmail accounts, very fast delivery!', rating: 5, date: '2024-12-15' },
            ...
            document.querySelectorAll('.detailBtn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    // Update detail image from the card's image
                    var cardImage = card.querySelector('.card-top-image img');
                    var detailImage = document.getElementById('detailProductImage');
                    if (detailImage && cardImage && cardImage.src) {
                        detailImage.src = cardImage.src;
                    }

                    // Use the Gmail data for rating/reviews (not shown on card)
                    var gdata = productData['gmail'];
                    if (gdata) {
