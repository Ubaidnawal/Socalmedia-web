...
<head>
    ...
    <title>Buy Premium Outlook Accounts | Verified & Bulk Outlook Accounts</title>
...
<!-- =========================================================
   HERO SECTION
   ========================================================= -->
<section class="outlook-hero-master-nexus section-padding" id="outlookHeroMaster" style="background: #ffffff; position:relative; overflow-x: hidden; overflow-y: hidden;">
    <!-- Subtle background shapes -->
    <div style="position:absolute; top:-20%; right:-10%; width:500px; height:500px; background:radial-gradient(circle, rgba(0,120,212,0.04) 0%, transparent 70%); border-radius:50%; pointer-events:none;"></div>
    <div style="position:absolute; bottom:-20%; left:-10%; width:400px; height:400px; background:radial-gradient(circle, rgba(0,120,212,0.03) 0%, transparent 70%); border-radius:50%; pointer-events:none;"></div>

    <div class="container position-relative" style="z-index:2;">
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="800">
                <span class="outlook-hero-badge" style="display:inline-flex; align-items:center; gap:8px; background:#f1f3f4; color:#444; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid #e8eaed;">
                    <i class="fas fa-envelope me-2" style="color:#0078D4;"></i> Premium Outlook Solutions
                </span>
                <h1 class="outlook-hero-headline" style="font-size:clamp(2.8rem,7vw,4.8rem); font-weight:800; line-height:1.08; color:#111; margin-bottom:20px; font-family:'Playfair Display',serif;">
                    Premium <span style="position:relative; display:inline-block; color:#0078D4;">Outlook<span style="position:absolute; bottom:4px; left:0; width:100%; height:8px; background:rgba(0,120,212,0.12); border-radius:4px;"></span></span> Accounts
                </h1>
                <p class="outlook-hero-subtitle" style="font-size:1.1rem; color:rgba(0,0,0,0.6); max-width:520px; margin:0 0 28px 0; line-height:1.7;">
                    High-quality Outlook accounts for business, marketing, registration, verification, and digital growth.
                </p>
                <div class="outlook-hero-cta-group d-flex flex-wrap gap-3">
                    <a href="#outlookProducts" class="outlook-hero-btn-primary" style="background:#0078D4; color:#fff; border:none; padding:14px 36px; border-radius:60px; font-weight:700; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:10px; box-shadow:0 8px 24px rgba(0,120,212,0.25);">
                        <i class="fas fa-rocket"></i> Explore Accounts
                    </a>
                    <a href="#outlookFAQs" class="outlook-hero-btn-secondary" style="background:transparent; color:#444; border:1.5px solid #dadce0; padding:12px 32px; border-radius:60px; font-weight:600; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:8px;">
                        <i class="fas fa-circle-question"></i> Learn More
                    </a>
                </div>
                <div class="outlook-hero-stats d-flex flex-wrap gap-4 mt-5">
                    <div class="outlook-stat-item" style="text-align:center;">
                        <div class="outlook-stat-number" style="font-size:2.2rem; font-weight:800; color:#111; display:block; line-height:1.1;" data-outlook-counter=""></div>
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="outlook-types-master-nexus section-padding" id="outlookAccountTypes" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="outlook-types-header text-center mb-5" data-aos="fade-up">
            <span class="outlook-types-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-th-large me-2"></i> Account Types
            </span>
            <h2 class="outlook-types-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Choose Your <span style="position:relative; display:inline-block; color:#023b45;">Outlook<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Package
            </h2>
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">Select the perfect Outlook account type for your needs</p>
        </div>
        <div class="outlook-types-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <!-- Type 1: Fresh Outlook -->
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="100">
                <div class="outlook-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">ðŸ†•</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Fresh Outlook Accounts</h3>
                    ...
                    <!-- <a href="#outlookProducts" class="outlook-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;"></a> -->
                </div>
            </div>
            <!-- Type 2: PVA Outlook -->
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="150">
                <div class="outlook-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:2px solid #023b45; position:relative;">
                    ...
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">ðŸ“ž</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">PVA Outlook Accounts</h3>
                    ...
                    <!-- <a href="#outlookProducts" class="outlook-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;">Order Now â†’</a> -->
                </div>
            </div>
            <!-- Type 3: Aged Outlook -->
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="200">
                <div class="outlook-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">ðŸ“œ</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Aged Outlook Accounts</h3>
            ...
            <!-- Type 4: Business Outlook -->
            <!-- <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="250"> -->
                <!-- <div class="outlook-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">ðŸ’¼</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Business Outlook Accounts</h3>
            ...
            <!-- <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="300"> -->
                <!-- <div class="outlook-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">ðŸ“¦</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Bulk Outlook Packages</h3>
                    ...
                    <a href="#outlookProducts" class="outlook-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;">Inquire Now â†’</a>
                </div>
            </div>
        </div>
    </div> -->
   ...
   ========================================================= -->
    ...
    <style>
        ...
        * {
        ...
        ============================================ */
        /* â”€â”€ Hero blob backgrounds: too big on mobile â†’ hide â”€â”€ */
        @media (max-width: 768px) {
            .outlook-hero-master-nexus > div[style*="position:absolute"] {
                display: none !important;
            }
        }
        /* â”€â”€ Hero subtitle: fixed max-width overflows on small screens â”€â”€ */
        @media (max-width: 576px) {
            .outlook-hero-subtitle { max-width: 100% !important; }
        }
        /* â”€â”€ Card images: fixed height needs to scale â”€â”€ */
        @media (max-width: 576px) {
        ...
        /* â”€â”€ Modal: fit mobile screen â”€â”€ */
        @media (max-width: 576px) {
        ...
        /* â”€â”€ Customer reviews section â”€â”€ */
        @media (max-width: 576px) {
        ...
        /* â”€â”€ Small desktop: squeeze 4 cards â”€â”€ */
...
<body>
    ...
    <div class="cards-premium-container">
        ...
        <div class="section-head" data-aos="fade-up">
            ...
            <p class="section-sub-head"><em>Fresh, verified &amp; instantly delivered â€” trusted by 15k+ creators worldwide</em></p>
        </div>
            ...
            <div class="col" data-product-id="outlook">
                <div class="attract-card">
                    ...
                    <div class="card-content">
                        ...
                        <p class="short-desc"><em>Premium Outlook ready, aged profiles, instant access</em></p>
                        <h5><em>fresh Account </em></h5>
                        <div class="product-rating">
                            <div class="star-rating" data-product="outlook"></div>
                            <span class="rating-count" data-product="outlook">(128 reviews)</span>
                        </div>
                        ...
                        <div class="stock-info"><i class="fas fa-check-circle in-stock"></i> In Stock â€” <strong>245</strong> available</div>
                        ...
                        <div class="btn-group-premium">
                            ...
                            <button class="btn-gradient-cart addCartBtn" data-name="Outlook Accounts"><i class="fas fa-shopping-cart"></i> <span class="cart-text">Add to Cart</span><span class="spinner"></span></button>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div class="col" data-product-id="outlook">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="detail-image-wrap">
                                <img id="detailProductImage" src="../Image/outlook.jpg" alt="Product Detail">
                            </div>
                            <div class="mt-3 d-flex gap-3 flex-wrap">
                                <span class="badge" style="background:#023b45; color:white; padding:0.4rem 1rem;"><i class="fas fa-star me-1"></i> <span id="detailRating">4.5</span> â˜…</span>
    ...
    <script>
        (function() {
            ...
            // ============================
            // PRODUCT DATA â€” Outlook only
            // ============================
            const productData = {
                gmail: {
                    name: 'Outlook Accounts',
                    desc: 'Premium Outlook ready, aged profiles with full recovery access and instant delivery.',
                    price: 40,
                    oldPrice: 55,
                    discount: '-27%',
                    stock: 245,
                    ...
                    reviews: [
                        { name: 'Alex J.', country: 'USA', text: 'Perfect Outlook accounts, very fast delivery!', rating: 5, date: '2024-12-15' },
            ...
            ratingContainers.forEach(container => {
                ...
                stars.forEach((star, idx) => {
                    ...
                    star.addEventListener('click', function(e) {
                        ...
                        showToast('â­ You rated this product ' + index + ' stars! Thank you.');
                    });
                });
            });
            ...
            // ADD TO CART
            // ============================
            // Inline add to cart â€” visual feedback only.
            ...
            document.querySelectorAll('.detailBtn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (qtyEl) modalProductTitle.textContent = (titleEl ? titleEl.textContent.trim() : 'Package') + ' â€” ' + qtyEl.textContent.trim();
                    ...
                    // Use the Outlook data for rating/reviews (not shown on card)
                    var gdata = productData['outlook'];
                    if (gdata) {
                    ...
                    if (detailImage) {
                        detailImage.src = '../Image/outlook.jpg';
                    }
            ...
            // Modal Add to Cart â€” calls server, updates counter
                    ...
                    for (let i = 5; i >= 1; i--) {
                        ...
                        barsHTML += `
                            <div class="distro-bar">
                                <span class="distro-label">${i} â˜…</span>
                        ...
                        reviewsHTML += `
                            <div class="review-card-item d-flex align-items-start gap-3">
                                ...
                                <div style="flex:1;">
                                    ...
                                    <div class="text-warning mb-1">${'â˜…'.repeat(r.rating)}${'â˜†'.repeat(5 - r.rating)}</div>
...
<!-- =========================================================
   WHY CHOOSE OUR OUTLOOK ACCOUNTS
   ========================================================= -->
<section class="outlook-why-master-nexus section-padding" id="outlookWhyChoose" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="outlook-why-header text-center mb-5" data-aos="fade-up">
            <span class="outlook-why-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-heart me-2"></i> Why Choose Us
            </span>
            <h2 class="outlook-why-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Why Our <span style="position:relative; display:inline-block; color:#023b45;">Outlook<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Accounts?
            </h2>
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">The advantages of choosing our premium Outlook services</p>
        </div>
        <div class="outlook-why-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
                <div class="outlook-why-card" style="background:white; border-radius:20px; padding:1.8rem 1.2rem; text-align:center; transition:all 0.3s; border:1px solid rgba(2,59,69,0.04); box-shadow:0 4px 15px rgba(0,0,0,0.04); height:100%;">
                    <div style="font-size:2.5rem; color:#023b45; margin-bottom:10px;">â­</div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="150">
                <div class="outlook-why-card" style="background:white; border-radius:20px; padding:1.8rem 1.2rem; text-align:center; transition:all 0.3s; border:1px solid rgba(2,59,69,0.04); box-shadow:0 4px 15px rgba(0,0,0,0.04); height:100%;">
                    <div style="font-size:2.5rem; color:#023b45; margin-bottom:10px;">ðŸ“ž</div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
                <div class="outlook-why-card" style="background:white; border-radius:20px; padding:1.8rem 1.2rem; text-align:center; transition:all 0.3s; border:1px solid rgba(2,59,69,0.04); box-shadow:0 4px 15px rgba(0,0,0,0.04); height:100%;">
                    <div style="font-size:2.5rem; color:#023b45; margin-bottom:10px;">âš¡</div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="250">
                <div class="outlook-why-card" style="background:white; border-radius:20px; padding:1.8rem 1.2rem; text-align:center; transition:all 0.3s; border:1px solid rgba(2,59,69,0.04); box-shadow:0 4px 15px rgba(0,0,0,0.04); height:100%;">
                    <div style="font-size:2.5rem; color:#023b45; margin-bottom:10px;">ðŸ”’</div>
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="outlook-features-master-nexus section-padding" id="outlookFeatures" style="background: #B7A08B;">
    <div class="container">
        <div class="outlook-features-header text-center mb-5" data-aos="fade-up">
            <span class="outlook-features-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-list-check me-2"></i> Account Features
            </span>
            <h2 class="outlook-features-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Premium <span style="position:relative; display:inline-block; color:#023b45;">Outlook<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Features
            </h2>
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">What makes our Outlook accounts exceptional</p>
        </div>
        <div class="outlook-features-grid row g-3" data-aos="fade-up" data-aos-delay="100">
            <div class="col-sm-6 col-md-4 col-lg-3" data-aos="flip-up" data-aos-delay="100">
                <div class="outlook-feature-item" style="background:white; border-radius:16px; padding:1rem 1.2rem; display:flex; align-items:center; gap:12px; transition:all 0.3s; border:1px solid rgba(2,59,69,0.04);">
...
<!-- =========================================================
   ORDER PROCESS
   ========================================================= -->
<section class="outlook-order-master-nexus section-padding" id="outlookOrderProcess" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="outlook-order-header text-center mb-5" data-aos="fade-up">
            <span class="outlook-order-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-route me-2"></i> Order Process
            </span>
            <h2 class="outlook-order-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
            ...
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">Order your Outlook accounts in minutes</p>
        </div>
        <div class="outlook-order-steps row g-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-md-6 col-lg-3" data-aos="fade-right" data-aos-delay="100">
                <div class="outlook-order-step" style="background:white; border-radius:20px; padding:1.8rem; text-align:center; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.3s; height:100%;">
                    ...
                    <h4 style="color:#023b45; font-weight:700; font-size:1.1rem;">Select Outlook Package</h4>
                    <p style="color:rgba(2,59,69,0.6); font-size:0.85rem;">Choose your preferred Outlook account type</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-right" data-aos-delay="250">
                <div class="outlook-order-step" style="background:white; border-radius:20px; padding:1.8rem; text-align:center; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.3s; height:100%;">
                    ...
                    <p style="color:rgba(2,59,69,0.6); font-size:0.85rem;">Get your Outlook accounts instantly</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="outlook-dashboard-master-nexus section-padding" id="outlookQualityDashboard" style="background: #B7A08B;">
    <div class="container">
        <div class="outlook-dashboard-header text-center mb-5" data-aos="fade-up">
            <span class="outlook-dashboard-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-chart-simple me-2"></i> Quality Dashboard
            </span>
            <h2 class="outlook-dashboard-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
        ...
        <div class="outlook-dashboard-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="outlook-dashboard-card" style="background:white; border-radius:20px; padding:1.8rem; box-shadow:0 8px 25px rgba(0,0,0,0.05);">
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="outlook-reviews-master-nexus section-padding" id="outlookReviews" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="outlook-reviews-header text-center mb-5" data-aos="fade-up">
            <span class="outlook-reviews-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-quote-left me-2"></i> Customer Reviews
            </span>
            <h2 class="outlook-reviews-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
        ...
        <div class="outlook-reviews-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <!-- Review 1-10 -->
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                <div class="outlook-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Best Outlook accounts I've ever purchased. Quality outstanding and delivery was instant."</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="150">
                <div class="outlook-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Great service! The aged Outlook accounts work perfectly for my business needs."</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                <div class="outlook-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Excellent quality Outlook accounts. The support team is very responsive and helpful."</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
                <div class="outlook-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Highly recommended! The aged Outlook accounts have great reputation and work perfectly."</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="400">
                <div class="outlook-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"The best Outlook account provider I've found. Quality is consistently excellent."</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="500">
                <div class="outlook-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Excellent quality Outlook accounts. Will definitely order again for my business."</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="550">
                <div class="outlook-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Great Outlook accounts for business use. The support team is very professional."</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="outlook-trust-master-nexus section-padding" id="outlookTrustSecurity" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="outlook-trust-header text-center mb-5" data-aos="fade-up">
            <span class="outlook-trust-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-shield-alt me-2"></i> Trust & Security
            </span>
            <h2 class="outlook-trust-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
        ...
        <div class="outlook-trust-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-md-6 col-lg-2" data-aos="zoom-in" data-aos-delay="100">
                <div class="outlook-trust-card" style="background:white; border-radius:16px; padding:1.2rem; text-align:center; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    <div style="font-size:2.2rem; color:#023b45; margin-bottom:6px;">ðŸ”’</div>
            ...
            <div class="col-md-6 col-lg-2" data-aos="zoom-in" data-aos-delay="150">
                <div class="outlook-trust-card" style="background:white; border-radius:16px; padding:1.2rem; text-align:center; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    <div style="font-size:2.2rem; color:#023b45; margin-bottom:6px;">âœ…</div>
            ...
            <div class="col-md-6 col-lg-2" data-aos="zoom-in" data-aos-delay="200">
                <div class="outlook-trust-card" style="background:white; border-radius:16px; padding:1.2rem; text-align:center; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    <div style="font-size:2.2rem; color:#023b45; margin-bottom:6px;">ðŸ›¡ï¸</div>
            ...
            <div class="col-md-6 col-lg-2" data-aos="zoom-in" data-aos-delay="250">
                <div class="outlook-trust-card" style="background:white; border-radius:16px; padding:1.2rem; text-align:center; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    <div style="font-size:2.2rem; color:#023b45; margin-bottom:6px;">â­</div>
            ...
            <div class="col-md-6 col-lg-2" data-aos="zoom-in" data-aos-delay="300">
                <div class="outlook-trust-card" style="background:white; border-radius:16px; padding:1.2rem; text-align:center; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    <div style="font-size:2.2rem; color:#023b45; margin-bottom:6px;">âš¡</div>
...
<!-- =========================================================
   FINAL CTA SECTION
   ========================================================= -->
<section class="outlook-cta-master-nexus section-padding" id="outlookFinalCTA" style="background: #023b45;">
    <div class="container">
        <div class="outlook-cta-wrapper text-center" data-aos="zoom-in" data-aos-duration="800">
            <div style="max-width:700px; margin:0 auto;">
                <h2 style="font-size:clamp(2.2rem,4.5vw,3.2rem); font-weight:800; color:#FEFAF7; font-family:'Playfair Display',serif; line-height:1.1; margin-bottom:16px;">
                    Ready To Order <span style="color:#B7A08B;">Premium Outlook Accounts</span>?
                </h2>
                <p style="font-size:1.1rem; color:rgba(254,250,247,0.8); margin:0 auto 30px;">
                    Get high-quality Outlook accounts with fast delivery and professional support.
                </p>
                <div class="outlook-cta-btn-group d-flex flex-wrap justify-content-center gap-3">
                    <a href="#outlookProducts" class="outlook-cta-primary" style="background:#B7A08B; color:#023b45; border:none; padding:14px 38px; border-radius:60px; font-weight:700; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:10px;">
                        <i class="fas fa-shopping-cart"></i> Order Now
                    </a>
                    <a href="#" class="outlook-cta-secondary" style="background:transparent; color:#FEFAF7; border:2px solid rgba(254,250,247,0.3); padding:12px 34px; border-radius:60px; font-weight:600; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:8px;">
...
<!-- =========================================================
   ...
   ========================================================= -->
<style>
    /* ========== UNIQUE OUTLOOK PAGE STYLES ========== */
    .section-padding {
        padding: 80px 0;
    }
    
    /* Hero hover effects */
    .outlook-hero-btn-primary:hover {
        background: #006cbd !important;
        transform: translateY(-3px);
        box-shadow: 0 10px 30px rgba(0,120,212,0.35);
    }
    .outlook-hero-btn-secondary:hover {
    ...
    /* Product card hover */
    .outlook-product-card:hover {
        transform: translateY(-8px);
        box-shadow: 0 16px 40px rgba(0,0,0,0.12) !important;
    }
    .outlook-product-cart-btn:hover {
        background: #012b34 !important;
        transform: scale(0.97);
    }
    .outlook-product-detail-btn:hover {
        background: rgba(2,59,69,0.06) !important;
        border-color: #023b45 !important;
    }
    
    /* Why choose cards hover */
    .outlook-why-card:hover {
    ...
    /* Order steps hover */
    .outlook-order-step:hover {
        transform: translateY(-6px);
        box-shadow: 0 16px 40px rgba(0,0,0,0.10) !important;
    }
    
    /* Dashboard cards hover */
    .outlook-dashboard-card:hover {
        transform: translateY(-4px);
        box-shadow: 0 12px 30px rgba(0,0,0,0.08) !important;
    }
    
    /* Review cards hover */
    .outlook-review-card:hover {
        transform: translateY(-4px);
        box-shadow: 0 12px 30px rgba(0,0,0,0.08) !important;
        border-color: #023b45 !important;
    }
    ...
    .outlook-faq-toggle:not(.collapsed) {
        background: rgba(2,59,69,0.04) !important;
    }
    .outlook-faq-toggle:not(.collapsed) span i {
        transform: rotate(180deg);
    }
    
    /* Trust cards hover */
    .outlook-trust-card:hover {
        transform: translateY(-6px);
        box-shadow: 0 12px 30px rgba(0,0,0,0.08) !important;
        border-color: #023b45 !important;
    }
    ...
    @media (max-width: 767px) {
        ...
        .outlook-cta-btn-group {
            flex-direction: column;
            align-items: center;
        }
        .outlook-cta-btn-group a {
            width: 100%;
            max-width: 280px;
            justify-content: center;
        }
        .outlook-product-btns {
            flex-direction: column;
        }
        .outlook-product-btns button {
            width: 100%;
        }
        .outlook-dashboard-grid .col-md-6 {
            padding: 0 6px;
        }
        .outlook-reviews-grid .col-md-6 {
            padding: 0 6px;
        }
        .outlook-why-grid .col-md-6 {
            padding: 0 6px;
        }
        .outlook-features-grid .col-sm-6 {
            padding: 0 6px;
        }
        .outlook-trust-grid .col-md-6 {
            padding: 0 6px;
        }
        .outlook-types-grid .col-md-6 {
            padding: 0 6px;
        }
        .outlook-products-grid .col-md-6 {
            padding: 0 6px;
        }
        .outlook-order-steps .col-md-6 {
            padding: 0 6px;
        }
        .outlook-faq-toggle {
    ...
    @media (max-width: 575px) {
        ...
        .outlook-product-card {
            padding: 0 !important;
        }
        .outlook-product-card h4 {
            font-size: 0.9rem !important;
        }
        .outlook-product-card .outlook-product-cart-btn,
        .outlook-product-card .outlook-product-detail-btn {
        ...
        .outlook-review-card p {
            font-size: 0.8rem !important;
        }
        .outlook-dashboard-card {
            padding: 1rem !important;
        }
        .outlook-dashboard-card span {
            font-size: 0.9rem !important;
        }
        .outlook-order-step {
            padding: 1rem !important;
        }
        .outlook-order-step h4 {
            font-size: 0.95rem !important;
        }
        .outlook-trust-card {
            padding: 0.8rem !important;
        }
        .outlook-trust-card div:first-child {
            font-size: 1.8rem !important;
        }
        .outlook-trust-card div:last-child {
            font-size: 0.7rem !important;
        }
    }

    /* â”€â”€ Scrollbar fix: force hide overflow on hero and all children â”€â”€ */
    html, body { overflow-x: hidden; width: 100%; max-width: 100%; }
    .outlook-hero-master-nexus,
    .outlook-hero-master-nexus * {
...
<script>
    (function() {
        ...
        // COUNTER ANIMATIONS
        // ============================
        function startOutlookCounters() {
            const counters = document.querySelectorAll('[data-outlook-counter]');
            counters.forEach(el => {
                const target = parseInt(el.getAttribute('data-outlook-counter'));
        ...
        const counterObserver = new IntersectionObserver((entries) => {
            ...
            if (shouldStart) {
                startOutlookCounters();
                counterObserver.disconnect();
            }
        }, { threshold: 0.3 });
        
        const heroSection = document.getElementById('outlookHeroMaster');
        if (heroSection) {
        ...
        // ============================
        document.querySelectorAll('.outlook-faq-toggle').forEach(btn => {
            btn.addEventListener('click', function() {
        ...
        // ADD TO CART BUTTONS
        // ============================
        document.querySelectorAll('.outlook-product-cart-btn').forEach(btn => {
            btn.addEventListener('click', function() {
        ...
        console.log('âœ… Premium Outlook Accounts Page loaded successfully.');
    })();
</script>
<?php
