...
<!-- =========================================================
   HERO SECTION
   ========================================================= -->
<section class="gmail-hero-master-nexus section-padding" id="gmailHeroMaster" style="background: linear-gradient(135deg, #1877F2 0%, #1a6dd4 35%, #0D5FD3 65%, #0a4da8 100%); position:relative; overflow-x: hidden; overflow-y: hidden;">
    <!-- Animated background shapes - Facebook blue glows -->
    <div style="position:absolute; top:-20%; right:-10%; width:600px; height:600px; background:radial-gradient(circle, rgba(255,255,255,0.08) 0%, transparent 70%); border-radius:50%; pointer-events:none; animation:gmailFloatBlob 8s ease-in-out infinite alternate;"></div>
    <div style="position:absolute; bottom:-20%; left:-10%; width:450px; height:450px; background:radial-gradient(circle, rgba(255,255,255,0.05) 0%, transparent 70%); border-radius:50%; pointer-events:none; animation:gmailFloatBlob 10s ease-in-out infinite alternate-reverse;"></div>
    ...
    <div class="container position-relative" style="z-index:2;">
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="800">
                <span class="gmail-hero-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(255,255,255,0.15); color:#ffffff; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(255,255,255,0.2);">
                ...
                <h1 class="gmail-hero-headline" style="font-size:clamp(2.8rem,7vw,4.8rem); font-weight:800; line-height:1.08; color:#ffffff; margin-bottom:20px; font-family:'Playfair Display',serif;">
                    Premium <span style="position:relative; display:inline-block; color:#ffffff;">Facebook<span style="position:absolute; bottom:4px; left:0; width:100%; height:8px; background:rgba(255,255,255,0.2); border-radius:4px;"></span></span> Accounts
                </h1>
                <p class="gmail-hero-subtitle" style="font-size:1.1rem; color:rgba(255,255,255,0.85); max-width:520px; margin:0 0 28px 0; line-height:1.7;">
                ...
                <div class="gmail-hero-cta-group d-flex flex-wrap gap-3">
                    <a href="#gmailProducts" class="gmail-hero-btn-primary" style="background:#ffffff; color:#1877F2; border:none; padding:14px 36px; border-radius:60px; font-weight:700; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:10px; box-shadow:0 8px 24px rgba(0,0,0,0.15);">
                        <i class="fas fa-rocket"></i> Explore Accounts
                    </a>
                    <a href="#gmailFAQs" class="gmail-hero-btn-secondary" style="background:rgba(255,255,255,0.1); color:#ffffff; border:1.5px solid rgba(255,255,255,0.25); padding:12px 32px; border-radius:60px; font-weight:600; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:8px;">
                ...
                <div class="gmail-hero-stats d-flex flex-wrap gap-4 mt-5">
                    <div class="gmail-stat-item" style="text-align:center;">
                        ...
                        <div style="font-size:0.8rem; color:rgba(255,255,255,0.7);"></div>
                    </div>
                    <div class="gmail-stat-item" style="text-align:center;">
                        <div class="gmail-stat-number" style="font-size:2.2rem; font-weight:800; color:#ffffff; display:block; line-height:1.1;" data-gmail-counter=""></div>
                        <div style="font-size:0.8rem; color:rgba(255,255,255,0.7);"></div>
            ...
            <div class="col" data-product-id="facebook">
                <div class="attract-card">
                    ...
                    <div class="card-content">
                        ...
                        <h5><em>2012 - 2020  year</em></h5>
                        <div class="product-rating">
                            <div class="star-rating" data-product="facebook"></div>
                            <span class="rating-count" data-product="facebook">(215 reviews)</span>
                        </div>
                        <div class="price-modern">
                            <span class="current-price"><span class="price-unit">$</span>32</span>
            ...
            <div class="col" data-product-id="facebook">
                <div class="attract-card">
                    ...
                    <div class="card-content">
                        ...
                        <p class="short-desc"><em>10+ year old Facebook profiles with established history</em></p>
                        <h5><em>2012 - 2020  year</em></h5>
                        <div class="product-rating">
                            <div class="star-rating" data-product="facebook"></div>
                        ...
                        <div class="price-modern">
                            <span class="current-price"><span class="price-unit">$</span>160</span>
                ...
                <div class="attract-card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="price-modern">
                            ...
                            <span class="qty-badge"><i class="fas fa-database"></i> 1000 Accounts</span>
                        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="detail-image-wrap">
                                <img id="detailProductImage" src="../Image/facebook.jpg" alt="Product Detail">
                            </div>
        ...
        (function() {
            ...
            document.querySelectorAll('.detailBtn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (detailImage) {
                        detailImage.src = '../Image/facebook.jpg';
                    }
    ...
    <div class="container">
        <div class="gmail-why-header text-center mb-5" data-aos="fade-up">
            ...
            <h2 class="gmail-why-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Why Our <span style="position:relative; display:inline-block; color:#023b45;">Facebook<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Accounts?
            </h2>
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">The advantages of choosing our premium Facebook services</p>
        </div>
    ...
    <div class="container">
        <div class="gmail-features-header text-center mb-5" data-aos="fade-up">
            ...
            <h2 class="gmail-features-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Premium <span style="position:relative; display:inline-block; color:#023b45;">Facebook<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Features
            </h2>
        ...
        <div class="gmail-cta-wrapper text-center" data-aos="zoom-in" data-aos-duration="800">
            <div style="max-width:700px; margin:0 auto;">
                <h2 style="font-size:clamp(2.2rem,4.5vw,3.2rem); font-weight:800; color:#FEFAF7; font-family:'Playfair Display',serif; line-height:1.1; margin-bottom:16px;">
                    Ready To Order <span style="color:#B7A08B;">Premium Facebook Accounts</span>?
                </h2>
                <p style="font-size:1.1rem; color:rgba(254,250,247,0.8); margin:0 auto 30px;">
                    Get high-quality facebook accounts with fast delivery and professional support.
                </p>
