...
<head>
    ...
    <title>Buy Premium TikTok Accounts | Verified & Bulk TikTok Accounts</title>
...
<!-- =========================================================
   HERO SECTION
   ========================================================= -->
<section class="tiktok-hero-master-nexus section-padding" id="tiktokHeroMaster" style="background: #ffffff; position:relative; overflow-x: hidden; overflow-y: hidden;">
    <!-- Subtle background shapes -->
    <div style="position:absolute; top:-20%; right:-10%; width:500px; height:500px; background:radial-gradient(circle, rgba(254,44,85,0.04) 0%, transparent 70%); border-radius:50%; pointer-events:none;"></div>
    ...
    <div class="container position-relative" style="z-index:2;">
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="800">
                <span class="tiktok-hero-badge" style="display:inline-flex; align-items:center; gap:8px; background:#f1f3f4; color:#444; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid #e8eaed;">
                    <i class="fab fa-tiktok me-2" style="color:#000000;"></i> Premium TikTok Solutions
                </span>
                <h1 class="tiktok-hero-headline" style="font-size:clamp(2.8rem,7vw,4.8rem); font-weight:800; line-height:1.08; color:#111; margin-bottom:20px; font-family:'Playfair Display',serif;">
                    Premium <span style="position:relative; display:inline-block; color:#FE2C55;">TikTok<span style="position:absolute; bottom:4px; left:0; width:100%; height:8px; background:rgba(254,44,85,0.12); border-radius:4px;"></span></span> Accounts
                </h1>
                <p class="tiktok-hero-subtitle" style="font-size:1.1rem; color:rgba(0,0,0,0.6); max-width:520px; margin:0 0 28px 0; line-height:1.7;">
                    High-quality TikTok accounts for business, marketing, registration, verification, and digital growth.
                </p>
                <div class="tiktok-hero-cta-group d-flex flex-wrap gap-3">
                    <a href="#tiktokProducts" class="tiktok-hero-btn-primary" style="background:#FE2C55; color:#fff; border:none; padding:14px 36px; border-radius:60px; font-weight:700; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:10px; box-shadow:0 8px 24px rgba(254,44,85,0.25);">
                        <i class="fas fa-rocket"></i> Explore Accounts
                    </a>
                    <a href="#tiktokFAQs" class="tiktok-hero-btn-secondary" style="background:transparent; color:#444; border:1.5px solid #dadce0; padding:12px 32px; border-radius:60px; font-weight:600; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:8px;">
                        <i class="fas fa-circle-question"></i> Learn More
                    </a>
                </div>
                <div class="tiktok-hero-stats d-flex flex-wrap gap-4 mt-5">
                    <div class="tiktok-stat-item" style="text-align:center;">
                        <div class="tiktok-stat-number" style="font-size:2.2rem; font-weight:800; color:#111; display:block; line-height:1.1;" data-tiktok-counter=""></div>
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="tiktok-types-master-nexus section-padding" id="tiktokAccountTypes" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="tiktok-types-header text-center mb-5" data-aos="fade-up">
            <span class="tiktok-types-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-th-large me-2"></i> Account Types
            </span>
            <h2 class="tiktok-types-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Choose Your <span style="position:relative; display:inline-block; color:#023b45;">TikTok<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Package
            </h2>
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">Select the perfect TikTok account type for your needs</p>
        </div>
        <div class="tiktok-types-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <!-- Type 1: Fresh TikTok -->
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="100">
                <div class="tiktok-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">ðŸ†•</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Fresh TikTok Accounts</h3>
                    ...
                    <!-- <a href="#tiktokProducts" class="tiktok-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;"></a> -->
                </div>
            </div>
            <!-- Type 2: PVA TikTok -->
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="150">
                <div class="tiktok-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:2px solid #023b45; position:relative;">
                    ...
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">PVA TikTok Accounts</h3>
                    ...
                    <!-- <a href="#tiktokProducts" class="tiktok-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;">Order Now â†’</a> -->
                </div>
            </div>
            <!-- Type 3: Aged TikTok -->
            <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="200">
                <div class="tiktok-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    ...
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Aged TikTok Accounts</h3>
            ...
            <!-- Type 4: Business TikTok -->
            <!-- <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="250"> -->
                <!-- <div class="tiktok-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">ðŸ’¼</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Business TikTok Accounts</h3>
            ...
            <!-- <div class="col-md-6 col-lg-4" data-aos="flip-up" data-aos-delay="300"> -->
                <!-- <div class="tiktok-type-card" style="background:white; border-radius:24px; padding:2rem 1.5rem; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.4s; height:100%; border:1px solid rgba(2,59,69,0.04);">
                    <div style="font-size:2.8rem; color:#023b45; margin-bottom:12px;">ðŸ“¦</div>
                    <h3 style="color:#023b45; font-weight:800; font-size:1.4rem; margin-bottom:4px;">Bulk TikTok Packages</h3>
                    ...
                    <a href="#tiktokProducts" class="tiktok-type-btn" style="background:#023b45; color:white; border:none; padding:8px 24px; border-radius:60px; font-weight:700; font-size:0.8rem; text-decoration:none; display:inline-block; transition:all 0.3s;">Inquire Now â†’</a>
                </div>
            </div>
        </div>
    </div> -->
   ...
   ========================================================= -->
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            .tiktok-hero-master-nexus > div[style*="position:absolute"] {
                display: none !important;
            }
        }
        /* â”€â”€ Hero subtitle: fixed max-width overflows on small screens â”€â”€ */
        @media (max-width: 576px) {
            .tiktok-hero-subtitle { max-width: 100% !important; }
        }
            ...
            <div class="col" data-product-id="tiktok">
                <div class="attract-card">
                    ...
                    <div class="card-content">
                        ...
                        <p class="short-desc"><em>Premium TikTok ready, aged profiles, instant access</em></p>
                        <div class="product-rating">
                            <div class="star-rating" data-product="tiktok"></div>
                            <span class="rating-count" data-product="tiktok">(128 reviews)</span>
                        </div>
                        ...
                        <div class="btn-group-premium">
                            ...
                            <button class="btn-gradient-cart addCartBtn" data-name="TikTok Accounts"><i class="fas fa-shopping-cart"></i> <span class="cart-text">Add to Cart</span><span class="spinner"></span></button>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div class="col" data-product-id="tiktok">
                <div class="attract-card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="price-modern">
                            <span class="current-price"><span class="price-unit">$</span>70</span>
  ...
  <div class="col" data-product-id="tiktok">
                <div class="attract-card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="price-modern">
                            <span class="current-price"><span class="price-unit">$</span>180</span>
  ...
  <div class="col" data-product-id="tiktok">
                <div class="attract-card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="price-modern">
                            <span class="current-price"><span class="price-unit">$</span>350</span>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="detail-image-wrap">
                                <img id="detailProductImage" src="../Image/tiktoke.jpg" alt="Product Detail">
                            </div>
    ...
    <script>
        (function() {
            ...
            // ============================
            // PRODUCT DATA â€” TikTok only
            // ============================
            const productData = {
                gmail: {
                    name: 'TikTok Accounts',
                    desc: 'Premium TikTok ready, aged profiles with full recovery access and instant delivery.',
                    price: 40,
                    oldPrice: 55,
                    discount: '-27%',
                    stock: 245,
                    ...
                    reviews: [
                        { name: 'Alex J.', country: 'USA', text: 'Perfect TikTok accounts, very fast delivery!', rating: 5, date: '2024-12-15' },
            ...
            document.querySelectorAll('.detailBtn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    // Use the TikTok data for rating/reviews (not shown on card)
                    var gdata = productData['tiktok'];
                    if (gdata) {
                    ...
                    if (detailImage) {
                        detailImage.src = '../Image/tiktoke.jpg';
                    }
...
<!-- =========================================================
   WHY CHOOSE OUR TIKTOK ACCOUNTS
   ========================================================= -->
<section class="tiktok-why-master-nexus section-padding" id="tiktokWhyChoose" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="tiktok-why-header text-center mb-5" data-aos="fade-up">
            <span class="tiktok-why-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-heart me-2"></i> Why Choose Us
            </span>
            <h2 class="tiktok-why-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Why Our <span style="position:relative; display:inline-block; color:#023b45;">TikTok<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Accounts?
            </h2>
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">The advantages of choosing our premium TikTok services</p>
        </div>
        <div class="tiktok-why-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
                <div class="tiktok-why-card" style="background:white; border-radius:20px; padding:1.8rem 1.2rem; text-align:center; transition:all 0.3s; border:1px solid rgba(2,59,69,0.04); box-shadow:0 4px 15px rgba(0,0,0,0.04); height:100%;">
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="tiktok-features-master-nexus section-padding" id="tiktokFeatures" style="background: #B7A08B;">
    <div class="container">
        <div class="tiktok-features-header text-center mb-5" data-aos="fade-up">
            <span class="tiktok-features-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-list-check me-2"></i> Account Features
            </span>
            <h2 class="tiktok-features-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
                Premium <span style="position:relative; display:inline-block; color:#023b45;">TikTok<span style="position:absolute; bottom:2px; left:0; width:100%; height:4px; background:rgba(2,59,69,0.2); border-radius:4px;"></span></span> Features
            </h2>
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">What makes our TikTok accounts exceptional</p>
        </div>
        <div class="tiktok-features-grid row g-3" data-aos="fade-up" data-aos-delay="100">
            <div class="col-sm-6 col-md-4 col-lg-3" data-aos="flip-up" data-aos-delay="100">
                <div class="tiktok-feature-item" style="background:white; border-radius:16px; padding:1rem 1.2rem; display:flex; align-items:center; gap:12px; transition:all 0.3s; border:1px solid rgba(2,59,69,0.04);">
...
<!-- =========================================================
   ORDER PROCESS
   ========================================================= -->
<section class="tiktok-order-master-nexus section-padding" id="tiktokOrderProcess" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="tiktok-order-header text-center mb-5" data-aos="fade-up">
            <span class="tiktok-order-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-route me-2"></i> Order Process
            </span>
            <h2 class="tiktok-order-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
            ...
            <p style="color:rgba(2,59,69,0.7); max-width:550px; margin:0 auto;">Order your TikTok accounts in minutes</p>
        </div>
        <div class="tiktok-order-steps row g-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-md-6 col-lg-3" data-aos="fade-right" data-aos-delay="100">
                <div class="tiktok-order-step" style="background:white; border-radius:20px; padding:1.8rem; text-align:center; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.3s; height:100%;">
                    ...
                    <h4 style="color:#023b45; font-weight:700; font-size:1.1rem;">Select TikTok Package</h4>
                    <p style="color:rgba(2,59,69,0.6); font-size:0.85rem;">Choose your preferred TikTok account type</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-right" data-aos-delay="250">
                <div class="tiktok-order-step" style="background:white; border-radius:20px; padding:1.8rem; text-align:center; box-shadow:0 8px 25px rgba(0,0,0,0.05); transition:all 0.3s; height:100%;">
                    ...
                    <p style="color:rgba(2,59,69,0.6); font-size:0.85rem;">Get your TikTok accounts instantly</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="tiktok-dashboard-master-nexus section-padding" id="tiktokQualityDashboard" style="background: #B7A08B;">
    <div class="container">
        <div class="tiktok-dashboard-header text-center mb-5" data-aos="fade-up">
            <span class="tiktok-dashboard-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-chart-simple me-2"></i> Quality Dashboard
            </span>
            <h2 class="tiktok-dashboard-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
        ...
        <div class="tiktok-dashboard-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="tiktok-dashboard-card" style="background:white; border-radius:20px; padding:1.8rem; box-shadow:0 8px 25px rgba(0,0,0,0.05);">
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="tiktok-reviews-master-nexus section-padding" id="tiktokReviews" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="tiktok-reviews-header text-center mb-5" data-aos="fade-up">
            <span class="tiktok-reviews-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-quote-left me-2"></i> Customer Reviews
            </span>
            <h2 class="tiktok-reviews-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
        ...
        <div class="tiktok-reviews-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <!-- Review 1-10 -->
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                <div class="tiktok-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Best TikTok accounts I've ever purchased. Quality outstanding and delivery was instant."</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="150">
                <div class="tiktok-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Great service! The aged TikTok accounts work perfectly for my business needs."</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                <div class="tiktok-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Excellent quality TikTok accounts. The support team is very responsive and helpful."</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
                <div class="tiktok-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Highly recommended! The aged TikTok accounts have great reputation and work perfectly."</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="400">
                <div class="tiktok-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"The best TikTok account provider I've found. Quality is consistently excellent."</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="500">
                <div class="tiktok-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Excellent quality TikTok accounts. Will definitely order again for my business."</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="550">
                <div class="tiktok-review-card" style="background:white; border-radius:20px; padding:1.5rem; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
                    ...
                    <div style="color:#f5b042; font-size:0.8rem; letter-spacing:1px; margin-bottom:8px;">â˜…â˜…â˜…â˜…â˜…</div>
                    <p style="font-size:0.9rem; color:rgba(2,59,69,0.75); line-height:1.6;">"Great TikTok accounts for business use. The support team is very professional."</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- =========================================================
   ...
   ========================================================= -->
<section class="tiktok-trust-master-nexus section-padding" id="tiktokTrustSecurity" style="background: rgba(255,255,255,0.12);">
    <div class="container">
        <div class="tiktok-trust-header text-center mb-5" data-aos="fade-up">
            <span class="tiktok-trust-badge" style="display:inline-flex; align-items:center; gap:8px; background:rgba(2,59,69,0.12); color:#023b45; font-weight:700; font-size:0.75rem; letter-spacing:1.5px; text-transform:uppercase; padding:6px 16px; border-radius:60px; margin-bottom:16px; border:0.5px solid rgba(2,59,69,0.15);">
                <i class="fas fa-shield-alt me-2"></i> Trust & Security
            </span>
            <h2 class="tiktok-trust-title" style="font-size:clamp(2rem,4vw,2.8rem); font-weight:800; line-height:1.15; color:#023b45; font-family:'Playfair Display',serif;">
        ...
        <div class="tiktok-trust-grid row g-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-md-6 col-lg-2" data-aos="zoom-in" data-aos-delay="100">
                <div class="tiktok-trust-card" style="background:white; border-radius:16px; padding:1.2rem; text-align:center; box-shadow:0 4px 15px rgba(0,0,0,0.04); transition:all 0.3s; height:100%;">
...
<!-- =========================================================
   FINAL CTA SECTION
   ========================================================= -->
<section class="tiktok-cta-master-nexus section-padding" id="tiktokFinalCTA" style="background: #023b45;">
    <div class="container">
        <div class="tiktok-cta-wrapper text-center" data-aos="zoom-in" data-aos-duration="800">
            <div style="max-width:700px; margin:0 auto;">
                <h2 style="font-size:clamp(2.2rem,4.5vw,3.2rem); font-weight:800; color:#FEFAF7; font-family:'Playfair Display',serif; line-height:1.1; margin-bottom:16px;">
                    Ready To Order <span style="color:#B7A08B;">Premium TikTok Accounts</span>?
                </h2>
                <p style="font-size:1.1rem; color:rgba(254,250,247,0.8); margin:0 auto 30px;">
                    Get high-quality TikTok accounts with fast delivery and professional support.
                </p>
                <div class="tiktok-cta-btn-group d-flex flex-wrap justify-content-center gap-3">
                    <a href="#tiktokProducts" class="tiktok-cta-primary" style="background:#B7A08B; color:#023b45; border:none; padding:14px 38px; border-radius:60px; font-weight:700; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:10px;">
                        <i class="fas fa-shopping-cart"></i> Order Now
                    </a>
                    <a href="#" class="tiktok-cta-secondary" style="background:transparent; color:#FEFAF7; border:2px solid rgba(254,250,247,0.3); padding:12px 34px; border-radius:60px; font-weight:600; font-size:0.95rem; transition:all 0.3s; text-decoration:none; display:inline-flex; align-items:center; gap:8px;">
...
<style>
    ...
    .tiktok-hero-btn-secondary:hover {
    ...
    .tiktok-product-cart-btn:hover {
        background: #012b34 !important;
        transform: scale(0.97);
    }
    .tiktok-product-detail-btn:hover {
    ...
    /* Order steps hover */
    .tiktok-order-step:hover {
        transform: translateY(-6px);
        box-shadow: 0 16px 40px rgba(0,0,0,0.10) !important;
    }
    
    /* Dashboard cards hover */
    .tiktok-dashboard-card:hover {
        transform: translateY(-4px);
        box-shadow: 0 12px 30px rgba(0,0,0,0.08) !important;
    }
    
    /* Review cards hover */
    .tiktok-review-card:hover {
        transform: translateY(-4px);
        box-shadow: 0 12px 30px rgba(0,0,0,0.08) !important;
        border-color: #023b45 !important;
    }
    ...
    /* FAQ toggle hover */
    .tiktok-faq-toggle:hover {
        background: rgba(2,59,69,0.02) !important;
    }
    .tiktok-faq-toggle:not(.collapsed) {
        background: rgba(2,59,69,0.04) !important;
    }
    .tiktok-faq-toggle:not(.collapsed) span i {
        transform: rotate(180deg);
    }
    
    /* Trust cards hover */
    .tiktok-trust-card:hover {
        transform: translateY(-6px);
        box-shadow: 0 12px 30px rgba(0,0,0,0.08) !important;
        border-color: #023b45 !important;
    }
    ...
    @media (max-width: 767px) {
        ...
        .tiktok-cta-btn-group {
            flex-direction: column;
            align-items: center;
        }
        .tiktok-cta-btn-group a {
            width: 100%;
            max-width: 280px;
            justify-content: center;
        }
        ...
        .tiktok-product-btns button {
            width: 100%;
        }
        .tiktok-dashboard-grid .col-md-6 {
            padding: 0 6px;
        }
        .tiktok-reviews-grid .col-md-6 {
            padding: 0 6px;
        }
        .tiktok-why-grid .col-md-6 {
            padding: 0 6px;
        }
        .tiktok-features-grid .col-sm-6 {
            padding: 0 6px;
        }
        .tiktok-trust-grid .col-md-6 {
            padding: 0 6px;
        }
        .tiktok-types-grid .col-md-6 {
            padding: 0 6px;
        }
        .tiktok-products-grid .col-md-6 {
            padding: 0 6px;
        }
        .tiktok-order-steps .col-md-6 {
            padding: 0 6px;
        }
        .tiktok-faq-toggle {
    ...
    @media (max-width: 575px) {
        ...
        .tiktok-product-card h4 {
            font-size: 0.9rem !important;
        }
        .tiktok-product-card .tiktok-product-cart-btn,
        .tiktok-product-card .tiktok-product-detail-btn {
        ...
        .tiktok-review-card p {
            font-size: 0.8rem !important;
        }
        .tiktok-dashboard-card {
            padding: 1rem !important;
        }
        .tiktok-dashboard-card span {
            font-size: 0.9rem !important;
        }
        .tiktok-order-step {
            padding: 1rem !important;
        }
        .tiktok-order-step h4 {
            font-size: 0.95rem !important;
        }
        .tiktok-trust-card {
            padding: 0.8rem !important;
        }
        .tiktok-trust-card div:first-child {
            font-size: 1.8rem !important;
        }
        .tiktok-trust-card div:last-child {
...
<script>
    (function() {
        ...
        // COUNTER ANIMATIONS
        // ============================
        function startTiktokCounters() {
            const counters = document.querySelectorAll('[data-tiktok-counter]');
            counters.forEach(el => {
                const target = parseInt(el.getAttribute('data-tiktok-counter'));
        ...
        const heroSection = document.getElementById('tiktokHeroMaster');
        if (heroSection) {
        ...
        // ============================
        document.querySelectorAll('.tiktok-faq-toggle').forEach(btn => {
            btn.addEventListener('click', function() {
        ...
        // ADD TO CART BUTTONS
        // ============================
        document.querySelectorAll('.tiktok-product-cart-btn').forEach(btn => {
            btn.addEventListener('click', function() {
        ...
        console.log('âœ… Premium TikTok Accounts Page loaded successfully.');
    })();
</script>
<?php
